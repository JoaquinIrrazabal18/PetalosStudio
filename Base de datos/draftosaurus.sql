-- Base de datos consolidada para Draftosaurus
-- Incluye todas las tablas, modificaciones y correcciones
-- Versión completa y corregida - Consolidado de todos los archivos SQL
...
-- Crear base de datos
CREATE DATABASE `draftosaurus` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `draftosaurus`;
...
CREATE TABLE `usuario` (
  ...
  `rol` enum('Jugador','Administrador','Invitado') NOT NULL DEFAULT 'Jugador',
...
CREATE TABLE `partida` (
  ...
  CONSTRAINT `partida_ibfk_1` FOREIGN KEY (`id_campeonato`) REFERENCES `campeonato` (`id_campeonato`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `participacion_p` (
  ...
  CONSTRAINT `participacion_p_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE,
  CONSTRAINT `participacion_p_ibfk_2` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE,
  CONSTRAINT `participacion_p_ibfk_3` FOREIGN KEY (`id_tablero`) REFERENCES `tablero` (`id_tablero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ronda` (
  ...
  KEY `id_partida` (`id_partida`),
  CONSTRAINT `ronda_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `dino_ficha` (
  ...
  KEY `id_partida` (`id_partida`),
  CONSTRAINT `dino_ficha_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `dado_turno` (
  ...
  CONSTRAINT `dado_turno_ibfk_1` FOREIGN KEY (`id_ronda`) REFERENCES `ronda` (`id_ronda`) ON DELETE CASCADE,
  CONSTRAINT `dado_turno_ibfk_2` FOREIGN KEY (`id_participacion`) REFERENCES `participacion_p` (`id_participacion`) ON DELETE CASCADE,
  CONSTRAINT `dado_turno_ibfk_3` FOREIGN KEY (`id_restriccion`) REFERENCES `restriccion` (`id_restriccion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `recinto` (
  ...
  KEY `id_tablero` (`id_tablero`),
  CONSTRAINT `recinto_ibfk_1` FOREIGN KEY (`id_tablero`) REFERENCES `tablero` (`id_tablero`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `colocado` (
  ...
  CONSTRAINT `colocado_ibfk_1` FOREIGN KEY (`id_dino_ficha`) REFERENCES `dino_ficha` (`id_dino_ficha`) ON DELETE CASCADE,
  CONSTRAINT `colocado_ibfk_2` FOREIGN KEY (`id_participacion`) REFERENCES `participacion_p` (`id_participacion`) ON DELETE CASCADE,
  CONSTRAINT `colocado_ibfk_3` FOREIGN KEY (`id_recinto`) REFERENCES `recinto` (`id_recinto`) ON DELETE CASCADE,
  CONSTRAINT `colocado_ibfk_4` FOREIGN KEY (`id_dado_turno`) REFERENCES `dado_turno` (`id_dado_turno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `dino_en_rio_descarte` (
  ...
  KEY `id_participacion` (`id_participacion`),
  KEY `id_dado_turno` (`id_dado_turno`),
  CONSTRAINT `dino_en_rio_descarte_ibfk_1` FOREIGN KEY (`id_dino_ficha`) REFERENCES `dino_ficha` (`id_dino_ficha`) ON DELETE CASCADE,
  CONSTRAINT `dino_en_rio_descarte_ibfk_2` FOREIGN KEY (`id_participacion`) REFERENCES `participacion_p` (`id_participacion`) ON DELETE CASCADE,
  CONSTRAINT `dino_en_rio_descarte_ibfk_3` FOREIGN KEY (`id_dado_turno`) REFERENCES `dado_turno` (`id_dado_turno`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- =============================================
-- TABLA MANO_DINOSAURIOS
-- =============================================
CREATE TABLE `mano_dinosaurios` (
  ...
  KEY `id_partida` (`id_partida`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `mano_dinosaurios_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE,
  CONSTRAINT `mano_dinosaurios_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- =============================================
-- TABLA TABLERO_POSICIONES
-- =============================================
CREATE TABLE `tablero_posiciones` (
  ...
  KEY `id_partida` (`id_partida`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `tablero_posiciones_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE,
  CONSTRAINT `tablero_posiciones_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `historial` (
  ...
  KEY `id_partida` (`id_partida`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `historial_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE,
  CONSTRAINT `historial_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- =============================================
-- TABLA BOT - ELIMINADA (Bots removidos del sistema)
-- =============================================

-- =============================================
-- TABLA CONVERSACION (Para DinoBot - Chatbot)
-- =============================================
CREATE TABLE `conversacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario` text NOT NULL COMMENT 'Mensaje del usuario',
  `bot` text NOT NULL COMMENT 'Respuesta de DinoBot',
...
INSERT INTO `usuario` (`nombre_usuario`, `email`, `contrasena_cifrada`, `fecha_registro`, `rol`) VALUES
('Admin', 'admin@draftosaurus.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW(), 'Administrador'),
('Joaquin', 'joaquinirrazabal947@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW(), 'Administrador'),
('Xavi', 'xavier2rama@gmail.com', '$2y$10$/WXGFqZ9nPYgYU.bfiTy.Orf8QpSplXaqy1rmNRjYHei09SwrZxjm', NOW(), 'Administrador'),
('Xamiercat', 'xamiercat@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW(), 'Administrador'),
('Julieta', 'juligarciag007@gmail.com', '$2y$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', NOW(), 'Administrador');
-- Bots eliminados del sistema - Sin inserts de bots
